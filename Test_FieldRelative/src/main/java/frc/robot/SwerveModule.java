...
public class SwerveModule {
  ...
  private double turnEncoderOffest;
  ...
  public SwerveModule(
    ...
    m_turningEncoder = new AnalogEncoder(turnEncoderchannel);

    if(turnEncoderchannel == 1){
        turnEncoderOffest = 0.8635; // Offset for right module (all black)
      }
      else{
        turnEncoderOffest = 0.170; // Offset for left module
      }
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    var encoderRotation = new Rotation2d(((m_turningEncoder.getAbsolutePosition()-turnEncoderOffest) *(2*Math.PI)));
